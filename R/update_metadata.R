...
#' @param field_meta A data frame matching the structure for field metadata generated by `create_metadata_tables()`
#' @param table_meta A data frame matching the structure for table metadata generated by `create_metadata_tables()`
